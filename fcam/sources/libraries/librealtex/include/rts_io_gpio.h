...
/**
 *enum the gpio pull value
 *
 *this enum defined the pull value of gpio
 */
enum rts_gpio_pull {
	GPIO_NONE	= 0,	/**<none*/
	GPIO_DOWN	= 1,	/**<down*/
 ...
 *@return the using state of gpio
 *			GPIO_NOT_REQUESTED: gpio has not be requested,
 *			GPIO_REQUESTED: gpio has be requested, <0:fail
 */
 ...
 *
 *@param rts_gpio	the point of struct rts_gpio
 *@return the pull value of gpio 0: NONE, 1: DOWN, 2: UP, <0: fail
 */
