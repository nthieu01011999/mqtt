...
int rts_osd2_set_color_table(RtsOsd2Inst posd, int fmt, uint32_t val,
			     ...
			     uint8_t alpha);
int rts_osd2_get_color_table(RtsOsd2Inst posd, int fmt, uint32_t *val,
				  uint8_t red, uint8_t green, uint8_t blue,
				  uint8_t alpha);
...
int rts_osd2_set_adma_copy(RtsOsd2Inst posd, int enable);
...
int rts_osd2_set_special_config(RtsOsd2Inst posd,
		struct rts_osd2_special_cfg *special, int blkidx);
int rts_osd2_get_special_config(RtsOsd2Inst posd,
		struct rts_osd2_special_cfg *special, int blkidx);
