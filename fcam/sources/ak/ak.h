...
extern void set_msg_root_task_id(ak_msg_t *msg, uint32_t root_task_id);
...
extern void task_root_post_pure_msg(uint32_t task_root_id, uint32_t task_src_id, uint32_t task_dst_id, uint32_t sig);
extern void task_root_post_pure_msg(uint32_t task_root_id, uint32_t task_dst_id, uint32_t sig);
extern void task_root_post_common_msg(uint32_t task_root_id, uint32_t task_src_id, uint32_t task_dst_id, uint32_t sig, uint8_t *data, uint32_t len);
extern void task_root_post_common_msg(uint32_t task_root_id, uint32_t task_dst_id, uint32_t sig, uint8_t *data, uint32_t len);
extern void task_root_post_dynamic_msg(uint32_t task_root_id, uint32_t task_src_id, uint32_t task_dst_id, uint32_t sig, uint8_t *data, uint32_t len);
extern void task_root_post_dynamic_msg(uint32_t task_root_id, uint32_t task_dst_id, uint32_t sig, uint8_t *data, uint32_t len);
...
extern uint32_t timer_set(uint32_t root_task_id, uint32_t des_task_id, uint32_t sig, uint32_t duty, timer_type_t timer_type);
 ...
 *
 *******************************************************************************/
#define TSM_EOT_SIGNAL		 (AK_USER_DEFINE_SIG - 1)	 // AK_USER_DEFINE_SIG - 1
